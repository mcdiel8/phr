	...
	<body>
		...
		<div id="show-especialidad" class="content scaffold-show" role="main">
			...
			<ol class="property-list especialidad">
				...
				<g:if test="${especialidadInstance?.descripcion}">
				<li class="fieldcontain">
					<span id="descripcion-label" class="property-label"><g:message code="especialidad.descripcion.label" default="Descripcion" /></span>
					
						<span class="property-value" aria-labelledby="descripcion-label"><g:fieldValue bean="${especialidadInstance}" field="descripcion"/></span>
